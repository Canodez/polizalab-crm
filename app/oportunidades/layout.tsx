...
export default function OportunidadesLayout({ children }: { children: React.ReactNode }) {
      ...
      <div className="bg-white border-b border-zinc-200">
        <div className="mx-auto max-w-5xl px-4 py-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-500 mt-0.5">Gestiona tu pipeline de ventas</p>
          </div>
          <Link
